...
Usage: python genymotionSyscallAnalysis.py username api_key realOrFake\n
...
def runExperiments(username,api_key,currentPath,apkFolderPath,outputDirectoryPath,apkDict,realOrFake):
	print username,api_key,currentPath,apkFolderPath,outputDirectoryPath,realOrFake
...
def main(argv):
	if len(sys.argv) != 4:
		sys.stderr.write('Usage: python genymotionSyscallAnalysis.py username api_key realOrFake\n')
		sys.exit(1)
