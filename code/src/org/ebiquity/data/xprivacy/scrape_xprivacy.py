...
# max_app = ""
# for app in app_dict:
#     counts.append(len(app_dict[app]['versions']))
#     count = count+len(app_dict[app]['versions'])
#     if len(app_dict[app]['versions']) > max_count:
#         max_count = len(app_dict[app]['versions'])
#         max_app = app
# from collections import Counter
# blah = Counter(counts)
# print blah
# print sorted(blah, key=blah.get) 
# print sorted(counts, reverse=True) 
# print max_app
# print max_count


def get_all_app_stats():
    app_dict = json.loads(open('appurls_versions.json').read())
